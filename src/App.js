        ...
        <Reveal width="100%">
          <section id="about" className="relative pt-24 pb-20 px-6 overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-10 py-5 bg-blue-700 hover:bg-blue-600 text-white rounded-2xl font-bold transition-all shadow-xl shadow-blue-500/20 transform hover:-translate-y-1">
                View Resume
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <ProjectCard
                  ...
                  tags={["React", "Tailwind"]}
                  link="https://ayo-adebesin.vercel.app"
                />
                <ProjectCard
                  title="Profile List"
